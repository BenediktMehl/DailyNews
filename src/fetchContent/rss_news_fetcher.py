...
def fetch_top_news(api_url="https://hacker-news.firebaseio.com/v0/topstories.json?print=pretty"):
    return fetch_top_news_from(api_url, "https://hacker-news.firebaseio.com/v0/item/{news_id}.json?print=pretty")

def fetch_top_news_from(api_url, news_item_url_template):
