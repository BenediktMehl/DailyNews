...
def create_news_post(news_topics, output_dir):
    ...
    news_topics_str = "\n\n".join(f"{topic['icon']} *{topic['entry_sentence']}* {topic['detail']} {topic['url']}" for topic in news_topics)
    news_topics_str = f"\n{news_topics_str}\n"
    ...
    file_path = f"{output_dir}/post.txt"
