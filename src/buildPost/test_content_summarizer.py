from company_llm_summarizer import create_news_summary
import unittest
...
class TestCreateNewsSummary(unittest.TestCase):
    ...
    def test_null_summary(self):
        ...
        summary = create_news_summary(nonsensical_text)
    ...
    def test_empty_input(self):
        empty_text = ""
        summary = create_news_summary(empty_text)
    ...
    def test_partial_fields(self):
        ...
        summary = create_news_summary(partial_text)
